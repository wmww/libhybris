...
Eight commits on top of [upstream libhybris](https://github.com/libhybris/libhybris), grouped into six problem areas, all aimed at making stock (unpatched) Android firmware usable from a glibc chroot.
